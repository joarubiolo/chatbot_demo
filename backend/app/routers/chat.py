...
def chat(request: ChatRequest):
    ...
    Saluda al cliente y preguntale como lo puedes ayudar, en caso de que el cliente quiera saber sobre viajes procede a recabar información de lo que desee.
